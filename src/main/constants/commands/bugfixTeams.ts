// Command: bugfix-teams — Bug fix pipeline (Korean)

export const CMD_BUGFIX_TEAMS = `버그 수정 파이프라인을 실행합니다.
...
| 2 | /dev-design | wiki/bugfix/{NNNN}.md 경로, 출력 번호 | wiki/specs/{NNNN}.md 존재 (>100B) |
